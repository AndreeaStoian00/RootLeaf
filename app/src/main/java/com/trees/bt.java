...
public class bt extends AppCompatActivity {
    ...
    public class BTree {
        ...
        int min(Node x) {
            return x.leaf ? x.key[0] : min(x.child[0]);
        }

        int max(Node x) {
            return x.leaf ? x.key[x.n - 1] : max(x.child[x.n]);
        }

        List<Integer> inorder(Node node, List<Integer> display) {
            for(int i = 0; i < node.n; i++){
                if(!node.leaf)
                    inorder(node.child[i], display);
                display.add(node.key[i]);
            }
            if(!node.leaf)
                inorder(node.child[node.n], display);
            return display;
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binord = (Button) findViewById(R.id.InorderBT);
        ...
        baN.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(TextUtils.isEmpty(insertedNode.getText().toString()))
                    ...
                    if(tree.Contain(Integer.parseInt(insertedNode.getText().toString())) == false){
        ...
        bdN.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(TextUtils.isEmpty(insertedNode.getText().toString()))
                    ...
                    if(tree.root == null) Toast.makeText(bt.this, "The tree is empty!", Toast.LENGTH_SHORT).show();
                    else {
                        if(tree.Contain(Integer.parseInt(insertedNode.getText().toString())) == false ){
                            Toast.makeText(bt.this, "Node " + insertedNode.getText().toString() + " does not exist!", Toast.LENGTH_SHORT).show();
                        } else{
                            tree.Remove(Integer.parseInt(insertedNode.getText().toString()));
        ...
        bminN.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                display = (TextView)findViewById(R.id.displayText3);
                if(tree.root.n == 0) Toast.makeText(bt.this, "The tree is empty!", Toast.LENGTH_SHORT).show();
                else display.setText("The minimum node is: " + tree.min(tree.root) + ".");
            }
        ...
        bmaxN.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                display = (TextView)findViewById(R.id.displayText3);
                if(tree.root.n == 0) Toast.makeText(bt.this, "The tree is empty!", Toast.LENGTH_SHORT).show();
                else display.setText("The maximum node is: " + tree.max(tree.root) + ".");
        ...
        binord.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                ...
                if(tree.root.n == 0) Toast.makeText(bt.this, "The tree is empty!", Toast.LENGTH_SHORT).show();
                    ...
                    List<Integer> displayI = new ArrayList<Integer>();
                    displayI = tree.inorder(tree.root, displayI);
                    display.setText("The inorder display of the tree is: " + displayI);
                    displayI.clear();
                }
            }
        });
